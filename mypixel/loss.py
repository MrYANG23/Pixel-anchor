...
class PixelLoss(nn.Module):
    ...
    def forward(self, gt_score, pred_score, gt_geo, pred_geo, ignored_map,attention_map):
        # print('----------------------------------进入pixelloss--------------------')
        ...
        #     return 0
        # print('---------------------------pixel_loss中的torch.sum(gt_score)--------:',torch.sum(gt_score))
        classify_loss = get_dice_loss(gt_score, pred_score * (1 - ignored_map))+get_dice_loss(attention_map,pred_score*(1-ignored_map))
